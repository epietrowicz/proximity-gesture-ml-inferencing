...
const char* ei_classifier_inferencing_categories[] = { "idle", "wave" };
...
const ei_impulse_t impulse_670590_0 = {
    .project_id = 670590,
    .project_owner = "Eric Pietrowicz",
    .project_name = "Proximity Gesture Detection",
    .impulse_id = 1,
    ...
    .fusion_string = "proximity + ambient_light",
    .slice_size = (100/4),
...
ei_impulse_handle_t impulse_handle_670590_0 = ei_impulse_handle_t( &impulse_670590_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_670590_0;
